...
class LdapUserProvider implements UserProviderInterface
{
    ...
    public function loadUserByUsername($username)
    {
        try {
            ...
            throw new UsernameNotFoundException(sprintf('UserData "%s" not found.', $username), 0, $e);
        }

        if (!$search) {
            throw new UsernameNotFoundException(sprintf('UserData "%s" not found.', $username));
        }
