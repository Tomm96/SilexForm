...
class DaoAuthenticationProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $userProvider = $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserProviderInterface');
        $userProvider->expects($this->once())
                     ->method('loadUserByUsername')
                     ->will($this->throwException(new UsernameNotFoundException()))
        ;

        $provider = new DaoAuthenticationProvider($userProvider, $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserCheckerInterface'), 'key', $this->getMock('Symfony\\Component\\Security\\Core\\Encoder\\EncoderFactoryInterface'));
        $method = new \ReflectionMethod($provider, 'retrieveUser');
        $method->setAccessible(true);
    ...
    public function testRetrieveUserReturnsUserFromTokenOnReauthentication()
    {
        ...
        $user = $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserInterface');
    ...
    public function testCheckAuthenticationWhenCredentialsAreEmpty()
    {
        ...
        $method->invoke(
            $provider,
            $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserInterface'),
            $token
        );
    }
    ...
    public function testCheckAuthenticationWhenCredentialsAreNotValid()
    {
        ...
        $method->invoke($provider, $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserInterface'), $token);
    }
    ...
    public function testCheckAuthenticationDoesNotReauthenticateWhenPasswordHasChanged()
    {
        ...
        $dbUser = $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserInterface');
    ...
    protected function getProvider($user = null, $userChecker = null, $passwordEncoder = null)
    {
        ...
        if (null === $userChecker) {
            $userChecker = $this->getMock('Symfony\\Component\\Security\\Core\\UserData\\UserCheckerInterface');
        }
